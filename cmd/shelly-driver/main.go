// Command shelly-driver is the Shelly client built as its own single-purpose binary, for
// packaging as a custom-installed driver on the remote. See cmd/deconz-driver/main.go's doc
// comment - this is the same shape, just for the "shelly" subcommand.
package main
